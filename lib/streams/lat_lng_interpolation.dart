...
import 'package:fluttermapexample/helpers/math_util.dart';
import 'package:fluttermapexample/helpers/spherical_util.dart';
import 'package:fluttermapexample/models/lat_lng_delta.dart';
import 'package:fluttermapexample/streams/lat_lng_delta_stream.dart';
import 'package:fluttermapexample/streams/lat_lng_stream.dart';
...
class LatLngInterpolationStream {
  ...
  void addLatLng(LatLng latLng) {
    if (subscription == null) {
      subscription = _latLngMovementInterpolation()
          .listen((latLng) => _rotateLatLng(latLng));
    }
